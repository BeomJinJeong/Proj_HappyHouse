<template>
  <card class="card-user">
    ...
    <div class="author">
      <!-- <a href="#"> -->
        <img class="avatar border-gray" src="https://www.pngitem.com/pimgs/m/30-307416_profile-icon-png-image-free-download-searchpng-employee.png" alt="..."/>

        <h4 class="title">김싸피<br />
